...
public class My_Dispute_History {
    ...
    public static void main(String[] args) {
        ...
        // Click My Dispute History
        WebElement mydisputehistoryButton = driver.findElement(By.xpath("/html/body/main/div/div[2]/div[2]/div/div/ul/li/a"));
        mydisputehistoryButton.click();
